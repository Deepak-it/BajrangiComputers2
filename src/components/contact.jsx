...
function Contact() {
    ...
    const [isContactFormValid, setContactFormValid] = useState(true);
                            ...
                            <form action="#!">
                                <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                    <div class="col-12">
                                        ...
                                        <input value = {formData.fullName} type="text" class="form-control" id="fullname" name="fullName" onChange = {handleChange} required></input>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" value={formData.email} onChange = {handleChange} required></input>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone" value={formData.phone} onChange = {handleChange}></input>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="subject" name="subject" value={formData.subject} onChange = {handleChange} required></input>
                                    </div>
                                    <div class="col-12">
                                        <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                                        <textarea value = {formData.message} onChange = {handleChange} class="form-control" id="message" name="message" rows="3" required></textarea>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button onClick = {handleSubmit} class="btn btn-primary btn-lg" type="submit">Send Message</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
